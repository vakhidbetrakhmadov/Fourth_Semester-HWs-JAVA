...
public class CompleteBinaryTree<E> extends BinaryTree<E> implements Iterable<E>, Collection<E>, Serializable {
    ...
    public boolean add(E data) {
        ...
        if (root == null)
            ...
            if (nextTreeNode.left == null)
                nextTreeNode.left = newNode;
            else
                nextTreeNode.right = newNode;
        }
        ++size;
        return true;
    }
    ...
    public CompleteBinaryTree<E> getLeftSubtree() {
        if (root != null && root.left != null) {
            return new CompleteBinaryTree<>(root.left, size(root.left));
        } else {
            return null;
        }
    }
    ...
    public CompleteBinaryTree<E> getRightSubtree() {
        if (root != null && root.right != null) {
            return new CompleteBinaryTree<>(root.right, size(root.right));
        } else {
            return null;
        }
    }
