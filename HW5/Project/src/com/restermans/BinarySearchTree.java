...
public class BinarySearchTree<E
        ...
        implements SearchTree<E>, Collection<E>, Iterable<E> {
    // Data Fields
    /**
    ...
    protected BinarySearchTree(Node<E> root, int size) {
        super(root, size);
    }
    ...
    public BinarySearchTree<E> getLeftSubtree() {
        if (root != null && root.left != null) {
            return new BinarySearchTree<>(root.left, size(root.left));
        } else {
            return null;
        }
    }
    ...
    public BinarySearchTree<E> getRightSubtree() {
        if (root != null && root.right != null) {
            return new BinarySearchTree<>(root.right, size(root.right));
        } else {
            return null;
        }
    }
     ...
     */
        public static BinarySearchTree<String> readBinaryTree(BufferedReader bR) throws IOException {
        BinarySearchTree<String> newBinarySearchTree = new BinarySearchTree<>();
        String data;
        while ((data = bR.readLine()) != null) {
            data = data.trim();
            if (!data.equals("null"))
                newBinarySearchTree.add(data);
        }
    ...
    //----------------------------------------------------------------------------------------------------------------//
    protected class BinarySearchTreeIterator extends BinaryTreeIterator implements Iterator<E> {
        protected void next(Deque<Node<E>> nextNodeQueue) {
            if (!hasNext())
