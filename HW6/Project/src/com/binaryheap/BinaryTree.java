...
public class BinaryTree<E>
    ...
    public BinaryTree(E data, BinaryTree<E> leftTree, BinaryTree<E> rightTree) {
        ...
        if (leftTree != null) {
            ...
            //set parent for the left child
            root.left.parent = root; //---------------- MODIFICATION -------------//
            size += leftTree.size;
        } else {
            root.left = null;
        }
        if (rightTree != null) {
            ...
            //set parent for the right child
            root.right.parent = root; //---------------- MODIFICATION -------------//
            size += rightTree.size;
        } else {
            root.right = null;
        }
    ...
    public BinaryTree<E> getLeftSubtree() {
        if (root != null && root.left != null) {
            ...
            return new BinaryTree<>(node, size(root.left));
        } else {
            return null;
        }
    }
    ...
    public BinaryTree<E> getRightSubtree() {
        if (root != null && root.right != null) {
            ...
            return new BinaryTree<>(node, size(root.right));
        } else {
            return null;
        }
    }
